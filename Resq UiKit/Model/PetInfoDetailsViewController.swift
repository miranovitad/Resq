...
class PetInfoDetailsViewController: UIViewController, UIPageViewControllerDelegate{
    ...
    var dogfile = [
        DogFile (dogImage: "Bailey",
                 ...
                 dogDescription: "Micky was found out the front of a notorious Dog Meat Restaurant in Bali. She was frail, scared and alone. She was being tormented by a young boy who threw rocks at, until we stepped in.", dogAgeEnum: AgeEnum.adult)
        //
    ]
